...
namespace AccountingEquipments.WindowsForms.Views
{
    public partial class ManufacturersView : UserControl
    {
        ...
        public ManufacturersView(DataManager manager, Manufacturer[] items)
        {
            _manager = manager;
            InitializeComponent();
        ...
        {
            var view = new ManufacturerView(_manager, lbItems, new Manufacturer() { Id = 0 });
        ...
        {
            var selected = (Manufacturer) lbItems.Items[lbItems.SelectedIndex];
            var view = new ManufacturerView(_manager, lbItems, selected);
            view.Anchor = Constants.FullScreenStyles;
            view.Width = this.rightPanel.Width;
            this.rightPanel.Controls.Clear();
            this.rightPanel.Controls.Add(view);
